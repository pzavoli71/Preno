...
<xsl:variable name="TitoloPagina">Test</xsl:variable>
...
<xsl:template match="Test">
	...
	<xsl:apply-templates select="/DOCUMENTO/Test/IdQuiz" mode="CampoEnumeratoX">
		...
		<xsl:with-param name="servlet">/preno/patente/HLstTest</xsl:with-param>
	...
	<!--xsl:apply-templates select="/DOCUMENTO/Test/IdQuiz" mode="CampoEnumerato">
	...
	<!--xsl:apply-templates select="/DOCUMENTO/Test/IdQuiz" mode="jqcombo">
	...
	<xsl:apply-templates select="/DOCUMENTO/Test/IdTest" mode="CampoIntero">
		<xsl:with-param name="size">10</xsl:with-param>
		<xsl:with-param name="chiave">true</xsl:with-param><xsl:with-param name="serial">true</xsl:with-param>
		<xsl:with-param name="caption">IdTest</xsl:with-param>
	</xsl:apply-templates>

	<xsl:apply-templates select="/DOCUMENTO/Test/EsitoTest" mode="CampoIntero">
		<xsl:with-param name="size">10</xsl:with-param>
		
		<xsl:with-param name="caption">EsitoTest</xsl:with-param>
	</xsl:apply-templates>

	<xsl:apply-templates select="/DOCUMENTO/Test/DtInizioTest" mode="CampoData">
		<xsl:with-param name="size">10</xsl:with-param>
		<xsl:with-param name="bOra"/>
		<xsl:with-param name="caption">DtInizioTest</xsl:with-param>
	</xsl:apply-templates>

	<xsl:apply-templates select="/DOCUMENTO/Test/DtFineTest" mode="CampoData">
		<xsl:with-param name="size">10</xsl:with-param>
		<xsl:with-param name="bOra"/>
