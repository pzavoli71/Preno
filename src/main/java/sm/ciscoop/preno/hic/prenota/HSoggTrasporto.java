...
/*-
 * Title:
 * Description:  Single per SoggTrasporto
 ...
 *
	...
	if @idnodo IS NULL
	  ...
	  END
	print @idnodo
	INSERT INTO zTrans ([CdPDC],[DsPDC],[IdNodo],[IdPadre],[Flag],[ultagg],[utente]) VALUES ('HSoggTrasporto' ,'HSoggTrasporto',@idnodo,0,0,GETDATE(),'appl')
	INSERT INTO zPermessi([CdGruppo],[CdPDC], [Descrizione], [Permesso], [ultagg], [utente]) VALUES (1, 'HSoggTrasporto',' ','LAGMIRVC',getdate(),'appl')
	--INSERT INTO zPermessi([CdGruppo],[CdPDC], [Descrizione], [Permesso], [ultagg], [utente]) VALUES (xxx, 'HSoggTrasporto',' ','LAGMIRVC',getdate(),'appl')


	// Voce di Menu.xml
	<Voce funzione="HSoggTrasporto" href="/prenota/HSoggTrasporto">Single HSoggTrasporto</Voce>

 *
 */

@WebServlet(value=HSoggTrasporto.SERVLET_URL, name = HSoggTrasporto.SERVLET_NAME) 
public class HSoggTrasporto extends AppSingleMask<SoggTrasporto> {

	
	private static final long  serialVersionUID = 1L;

	public static final String SERVLET_NAME     = "HSoggTrasporto";
	public static final String SERVLET_URL      = "/prenota/" + HSoggTrasporto.SERVLET_NAME;
	...
	public boolean afterExecIns(Passo nPasso, OpRes opRes) throws Exception {
		...
		if ( nPasso == Passo.ESECUZIONE && opRes == opRes.OK) {
    	  ...
    	  */
			...
			setRedirect(getServletFullPath() + "?MTipo=V&MPasso=2"+"&IdSoggTrasporto="+getPDC().getIdSoggTrasporto());
