...
/*-
 * Title:
 * Description:  Single per TipoTrasporto
 ...
 *
	...
	if @idnodo IS NULL
	  ...
	  END
	print @idnodo
	INSERT INTO zTrans ([CdPDC],[DsPDC],[IdNodo],[IdPadre],[Flag],[ultagg],[utente]) VALUES ('HTipoTrasporto' ,'HTipoTrasporto',@idnodo,0,0,GETDATE(),'appl')
	INSERT INTO zPermessi([CdGruppo],[CdPDC], [Descrizione], [Permesso], [ultagg], [utente]) VALUES (1, 'HTipoTrasporto',' ','LAGMIRVC',getdate(),'appl')
	--INSERT INTO zPermessi([CdGruppo],[CdPDC], [Descrizione], [Permesso], [ultagg], [utente]) VALUES (xxx, 'HTipoTrasporto',' ','LAGMIRVC',getdate(),'appl')


	// Voce di Menu.xml
	<Voce funzione="HTipoTrasporto" href="/prenota/HTipoTrasporto">Single HTipoTrasporto</Voce>

 *
 */

@WebServlet(value=HTipoTrasporto.SERVLET_URL, name = HTipoTrasporto.SERVLET_NAME) 
public class HTipoTrasporto extends AppSingleMask<TipoTrasporto> {

	
	private static final long  serialVersionUID = 1L;

	public static final String SERVLET_NAME     = "HTipoTrasporto";
	public static final String SERVLET_URL      = "/prenota/" + HTipoTrasporto.SERVLET_NAME;
	...
	public boolean afterExecIns(Passo nPasso, OpRes opRes) throws Exception {
		...
		if ( nPasso == Passo.ESECUZIONE && opRes == opRes.OK) {
    	  ...
    	  */
			...
			setRedirect(getServletFullPath() + "?MTipo=V&MPasso=2"+"&IdTpTrasporto="+getPDC().getIdTpTrasporto());
